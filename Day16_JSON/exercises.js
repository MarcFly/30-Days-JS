...
{
    // 1
    let students = Object.entries(JSON.parse(txt))
    console.log(students)

    // 2
    students = students.sort((a,b) => b[1].skills.length - a[1].skills.length) // Somehow the sort HERE affects log before this is executet ?????
    console.log(students)
}